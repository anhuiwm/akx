...
bool FishServer::ConnectHttp()
{
	...
	//处理HTTP的连接
	WORD HttpPort = 2680;
	DWORD HttpSleepTime = 1;
	DWORD HttpThreadSum = 1;
	DWORD HttpTimeOut = 30000;
	HttpServerInitData pHttpInitData;
	pHttpInitData.Port = HttpPort;
	pHttpInitData.SleepTime = HttpSleepTime;
	pHttpInitData.ThreadNum = HttpThreadSum;
	pHttpInitData.Timeout = HttpTimeOut;
