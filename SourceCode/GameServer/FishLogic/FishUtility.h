...
#define CAMERA_WIDTH	1280  //1024  
#define CAMERA_HEIGHT	720    //576
...
enum BulletType
{
	...
	BULLET_TYPE_SHOT,// 散弹属性
	BULLET_TYPE_PENETRATION_CHAIN,//定向穿透,定点爆炸
	BULLET_TYPE_PENETRATION_REBOUND,//穿透反弹，反弹三次，击杀三次
	BULLET_TYPE_PRNETRATION_LOCK,//穿透锁定,绕过去打锁定的鱼
	BULLET_TYPE_MAX,
	//wm to 后续删除
