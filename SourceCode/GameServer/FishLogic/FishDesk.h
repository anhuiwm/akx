...
protected:
	...
	void ProcessSkillGoldBullet(CRole *player);
	void ProcessSkillSilverBullet(CRole *player);
	void ProcessSkillBronzeBullet(CRole *player);
	...
	void ProcessSkillFrozen(CRole *player);
	void ProcessSkillCall(CRole *player);
	void ProcessSkillAccelerate(CRole *player);
