...
enum SubMainCmdType
{
	...
	SUB_SKILL_ACCELERATE_REQUEST,
	SUB_SKILL_ACCELERATE_RESPONSE,
	SUB_SKILL_CALL_REQUEST,
	SUB_SKILL_CALL_RESPONSE,
	SUB_SKILL_FROZEN_REQUEST,
	SUB_SKILL_FROZEN_RESPONSE,

	SUB_SKILL_GOLD_BULLET_REQUEST,
	SUB_SKILL_GOLD_BULLET_RESPONSE,

	SUB_SKILL_SILVER_BULLET_REQUEST,
	SUB_SKILL_SILVER_BULLET_RESPONSE,

	SUB_SKILL_BRONZE_BULLET_REQUEST,
	SUB_SKILL_BRONZE_BULLET_RESPONSE,
...
enum NetCmdType
{
	...
	CMD_LCOK_FISH = Main_Game << 8 | SubMainCmdType::SUB_LOCK_FISH,
	...
	CMD_SKILL_ACCELERATE_REQUEST = Main_Game << 8 | SubMainCmdType::SUB_SKILL_ACCELERATE_REQUEST,
	CMD_SKILL_ACCELERATE_RESPONSE = Main_Game << 8 | SubMainCmdType::SUB_SKILL_ACCELERATE_RESPONSE,
	CMD_SKILL_CALL_REQUEST = Main_Game << 8 | SubMainCmdType::SUB_SKILL_CALL_REQUEST,
	CMD_SKILL_CALL_RESPONSE = Main_Game << 8 | SubMainCmdType::SUB_SKILL_CALL_RESPONSE,
	CMD_SKILL_FROZEN_REQUEST = Main_Game << 8 | SubMainCmdType::SUB_SKILL_FROZEN_REQUEST,
	CMD_SKILL_FROZEN_RESPONSE = Main_Game << 8 | SubMainCmdType::SUB_SKILL_FROZEN_RESPONSE,
	...
	CMD_SKILL_GOLD_BULLET_REQUEST = Main_Game << 8 | SubMainCmdType::SUB_SKILL_GOLD_BULLET_REQUEST,
	CMD_SKILL_GOLD_BULLET_RESPONSE = Main_Game << 8 | SubMainCmdType::SUB_SKILL_GOLD_BULLET_RESPONSE,

	CMD_SKILL_SILVER_BULLET_REQUEST = Main_Game << 8 | SubMainCmdType::SUB_SKILL_SILVER_BULLET_REQUEST,
	CMD_SKILL_SILVER_BULLET_RESPONSE = Main_Game << 8 | SubMainCmdType::SUB_SKILL_SILVER_BULLET_RESPONSE,

	CMD_SKILL_BRONZE_BULLET_REQUEST = Main_Game << 8 | SubMainCmdType::SUB_SKILL_BRONZE_BULLET_REQUEST,
	CMD_SKILL_BRONZE_BULLET_RESPONSE = Main_Game << 8 | SubMainCmdType::SUB_SKILL_BRONZE_BULLET_RESPONSE,
	...
	CMD_TABLE_CHAT = Main_Game << 8 | SubMainCmdType::SUB_TABLE_CHAT,
};
...
enum FishCatchEventType
{
	...
	CATCH_EVENT_ATTACK = 2,
	CATCH_EVENT_EFFECT = 3,
	CATCH_EVENT_CATCHED_LIGHTING = 4,
	CATCH_EVENT_CATCHED_LIGHTING_MAIN = 5,
};
struct FishCatched
{
	byte	CatchEvent; 
...
struct NetCmdLockFish : public NetCmd
{
	ushort BulletID;
	ushort	FishID;
};
...
struct NetCmdSkillFrozen : public NetCmd
{
	byte	Seat;
	//UINT	GoldNum;
	//UINT	TotalNum;
...
struct NetCmdSkillAccelerate : NetCmd
{
	byte Seat;
};

struct NetCmdSkillBossFish : NetCmd
{
	byte Seat;
	ushort Fishgroup;
	ushort PathID;
...
struct NetCmdSkillGoldBullet : public NetCmd
{
	byte    Seat;
	UINT    GoldNum;
	UINT	TotalNum;
...
struct NetCmdSkillSilverBullet : public NetCmd
{
	byte    Seat;
	UINT    GoldNum;
	UINT	TotalNum;
...
struct NetCmdSkillBronzeBullet : public NetCmd
{
	byte    Seat;
	UINT    GoldNum;
	UINT	TotalNum;
