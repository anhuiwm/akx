...
void ChannelLogonManager::OnHandleLogonInfo(ServerClientData* pClient, LO_Cmd_ChannelLogon* pMsg)
{
	...
	TCHAR PostUrl[1024];
#if 0
		swprintf_s(PostUrl, CountArray(PostUrl), TEXT("login/check.html?sdk=09CE2B99C22E6D06&app=800018D72E2761D0&uin=123456&sess=abcdefghijklmn") );
#else
